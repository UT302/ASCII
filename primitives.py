...
# Open window, set title and dimensions.
arcade.open_window(600, 600, "Drawing Example")

# Set background color
arcade.set_background_color(arcade.color.WHITE)

# Set the render process
arcade.start_render()

# Draw a grid, draw vertical lines every 120 pixels
...
arcade.draw_rectangle_outline(295, 100, 45, 65, arcade.color.PURPLE)
arcade.draw_rectangle_outline(295, 160, 20, 45, arcade.color.PURPLE, 3, 45)
...
texture = arcade.load_texture("/home/ponch/.local/lib/python3.6/site-packages/arcade/examples/images/playerShip1_orange.png")
scale = .6
...
# Finish the render, nothing will be drawn without this
# Must happen after all draw commands
arcade.finish_render()

# Keep the window up untill user close it
arcade.run()
